...
// Source: internal/service/types.go
...
func (m *MockAdminRepository) GetStats(ctx context.Context) (*models.Stats, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAdminRepositoryMockRecorder) GetStats(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetStats", reflect.TypeOf((*MockAdminRepository)(nil).GetStats), ctx)
}
